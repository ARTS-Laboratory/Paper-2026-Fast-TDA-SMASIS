...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "scatter_matrix.autotvin.dat"
	set constFileTvOut       "scatter_matrix.autotvout.dat"
	set constFileHdlTvIn     "scatter_matrix.autohdltvin.dat"
	set constFileHdlTvOut    "scatter_matrix.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
