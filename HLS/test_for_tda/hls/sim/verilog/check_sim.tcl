...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.scatter_matrix.autotvin_accel.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.scatter_matrix.autotvout_S_tilde_0.dat"
         "rtl.scatter_matrix.autotvout_S_tilde_1.dat"
         "rtl.scatter_matrix.autotvout_S_tilde_2.dat"
         "rtl.scatter_matrix.autotvout_S_tilde_3.dat"
         "rtl.scatter_matrix.autotvout_S_tilde_4.dat"
         "rtl.scatter_matrix.autotvout_S_tilde_5.dat"
         "rtl.scatter_matrix.autotvout_S_tilde_6.dat"
         "rtl.scatter_matrix.autotvout_S_tilde_7.dat"
         "rtl.scatter_matrix.autotvout_S_tilde_8.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
