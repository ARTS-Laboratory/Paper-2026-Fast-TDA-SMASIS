...
if {[file isfile scatter_matrix.autotvin.dat]} {
	file delete -force scatter_matrix.autotvin.dat
}

if {[file isfile scatter_matrix.autotvout.dat]} {
	file delete -force scatter_matrix.autotvout.dat
}
