...
\SetAuthors{%
	...
	Austin R. J. Downey\affil{1}\CorrespondingAuthor{lienhard@mit.edu, kate@thepalace.gov}
	Jason D. Bakos\affil{2}
	Simon Laflamme, \affil{3}
	Gurcan Comert\affil{4}
...
zero diagonal entries, requiring a permuted LDLT factorization
